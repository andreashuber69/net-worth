...
describe(FastXpub.name, () => {
    describe("deriveNode", () => {
        it("should derive the correct nodes", async () => {
            ...
            const m0 = await sut.deriveNode("xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcFF8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhkJ8UB7WEGuduB", networks.bitcoin, 0);
